...
**Phase 2 — Selection & crop:** text-selection ask flow; overlay rect-crop mode with the coordinate-conversion helper + unit tests; PNG export. *Exit: both modes produce a correct `Question` from any zoom level.*
